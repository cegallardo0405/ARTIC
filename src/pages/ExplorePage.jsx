      ...
      <section className="border-b border-border bg-secondary py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <span className="text-xs uppercase tracking-[0.3em] text-muted-foreground">Colección</span>
            ...
            <p className="text-pretty mx-auto mt-4 max-w-2xl text-muted-foreground">
              Descubre obras maestras de todas las épocas y culturas. Busca por título, artista o palabra clave.
            </p>
          </div>
