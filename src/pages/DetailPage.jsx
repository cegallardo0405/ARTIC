        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
          <div className="order-1">
            <div className="sticky top-24">
              ...
              {artwork.is_public_domain && <p className="mt-4 text-center text-xs text-muted-foreground">Esta obra es de dominio público</p>}
            </div>
          </div>
            ...
            <div className="border-t border-border pt-8">
              ...
              <dl className="space-y-4">
                ...
                {artwork.classification_title && (
                  <div className="flex flex-col sm:flex-row sm:gap-4">
                    <dt className="min-w-[140px] text-sm text-muted-foreground">Clasificación</dt>
                ...
                {artwork.credit_line && (
                  <div className="flex flex-col border-t border-border pt-4 sm:flex-row sm:gap-4">
                    <dt className="min-w-[140px] text-sm text-muted-foreground">Crédito</dt>
