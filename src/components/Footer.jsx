    ...
    <footer className="border-t border-border bg-secondary" role="contentinfo">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4 md:gap-12">
          ...
          <div>
            <h3 className="mb-4 font-serif text-sm font-semibold uppercase tracking-widest">Navegación</h3>
          ...
          <div>
            <h3 className="mb-4 font-serif text-sm font-semibold uppercase tracking-widest">Información</h3>
        ...
        <div className="mt-12 border-t border-border pt-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <p className="text-xs text-muted-foreground">{currentYear} Galería ARTIC. Proyecto educativo.</p>
